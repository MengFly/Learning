...
public class AES {
	...
	private static String miyao = "我是密钥";

	public static void diyKey() {
		try {
			...
			System.out.println("diyKeyEncodeAESStr:" + Hex.encodeHexString(jdkAESBytes));

			// 进行解密
			cipher.init(Cipher.DECRYPT_MODE, key);
			byte[] jdkDecodeAESBytes = cipher.doFinal(jdkAESBytes);
			System.out.println("diyKeyDecodeAESStr:" + new String(jdkDecodeAESBytes));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
